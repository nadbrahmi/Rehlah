...
class _CheckInSlidersState extends State<CheckInSlidersScreen> {
  ...
  final _symptoms = [
    _Symptom(key:'fatigue', label:'Fatigue', arabicLabel:'إرهاق', emoji:'🌙', value:7),
    _Symptom(key:'pain', label:'Pain', arabicLabel:'ألم', emoji:'⚡', value:3),
    _Symptom(key:'nausea', label:'Nausea', arabicLabel:'غثيان', emoji:'🌊', value:5),
    _Symptom(key:'fever', label:'Fever / Temp', arabicLabel:'حمى / حرارة', emoji:'🌡️', value:0,
        warningText:'⚠ Fever above 38°C — call your care team now, day or night.'),
    _Symptom(key:'mood', label:'Mood', arabicLabel:'مزاج', emoji:'💜', value:4, isMoodInverted:true),
  ];

  Color _sevColor(double v, bool inv) {
    final iv = inv ? (10 - v) : v;
  ...
  String _sevLabel(double v, bool inv) {
    final iv = inv ? (10 - v) : v;
    if (v == 0) return 'None';
            ...
            children: [
              GestureDetector(
                ...
                child: Row(children: [
                  ...
                  Text('Back', style: AppText.caption.copyWith(color: AppColors.text2)),
                ]),
              ),
  ...
  Widget _buildCard(_Symptom s) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: s.value > 0 ? color.withOpacity(0.3) : AppColors.border,
        ...
        children: [
          Row(children: [
            Container(width:36, height:36,
              decoration: BoxDecoration(
                color: s.value > 0 ? color.withOpacity(0.12) : AppColors.primaryLight,
            ...
            Expanded(child: Column(
              ...
              children: [
                ...
                Text(s.arabicLabel,
                  style: AppText.body.copyWith(fontSize:12, color:AppColors.text3)),
              ],
            )),
            Container(width:36, height:36,
              decoration: BoxDecoration(
                color: s.value > 0 ? color.withOpacity(0.12) : AppColors.primaryLight,
                borderRadius: AppRadius.smBR),
              child: Center(child: Text('${s.value.toInt()}',
          ...
          SliderTheme(
            ...
            child: Slider(
              value: s.value, min:0, max:10, divisions:10,
          ...
          Row(
            ...
            children: [
              ...
              Text(_sevLabel(s.value, s.isMoodInverted),
                style: AppText.caption.copyWith(
          ...
          if (showInterference) ...[
            ...
            Wrap(
              ...
              children: opts.map((o) {
                final sel = s.interferenceAnswer == o;
                return GestureDetector(
                  onTap: () => setState(() => s.interferenceAnswer = o),
