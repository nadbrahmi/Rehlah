...
class ShellScreen extends StatelessWidget {
  ...
  int _navIndex(BuildContext context) {
    ...
    if (location.startsWith('/my-health')) return 1;
    if (location == '/care' || location.startsWith('/care/')) return 2;
      ...
      bottomNavigationBar: AppBottomNav(
        ...
        onTap: (i) {
          switch (i) {
            ...
            case 1: context.go('/my-health/journey'); break;
            case 2: context.go('/care'); break;
